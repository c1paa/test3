...
function check() {
    ...
    if (paint == 0) {
        ...
        document.getElementsByClassName('slider-1')[0].style.border = "black";
        document.getElementsByClassName('slider-2')[0].style.background = "#646464";
        document.getElementsByClassName('slider-2')[0].style.border = "#646464";
        document.getElementsByClassName('slider-3')[0].style.background = "#646464";
        document.getElementsByClassName('slider-3')[0].style.border = "#646464";
        document.getElementsByClassName('slider-4')[0].style.background = "#646464";
        document.getElementsByClassName('slider-4')[0].style.border = "#646464";
    }
    if (paint == 1) {
        document.getElementsByClassName('slider-1')[0].style.background = "#646464";
    ...
    if (paint == 2) {
        ...
        document.getElementsByClassName('slider-3')[0].style.border = "black";
        document.getElementsByClassName('slider-4')[0].style.background = "#646464";
        document.getElementsByClassName('slider-4')[0].style.border = "#646464";
    }
    if (paint == 3) {
        ...
        document.getElementsByClassName('slider-4')[0].style.border = "black";
    }
}
...
function check_two() {
    ...
    if (paint_two == 0) {
        ...
        document.getElementsByClassName('slider-1_two')[0].style.border = "black";
        document.getElementsByClassName('slider-2_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-2_two')[0].style.border = "#646464";
        document.getElementsByClassName('slider-3_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-3_two')[0].style.border = "#646464";
        document.getElementsByClassName('slider-4_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-4_two')[0].style.border = "#646464";
    }
    if (paint_two == 1) {
        document.getElementsByClassName('slider-1_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-1_two')[0].style.border = "#646464";
        document.getElementsByClassName('slider-2_two')[0].style.background = "black";
        document.getElementsByClassName('slider-2_two')[0].style.border = "black";
        document.getElementsByClassName('slider-3_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-3_two')[0].style.border = "#646464";
        document.getElementsByClassName('slider-4_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-4_two')[0].style.border = "#646464";
    ...
    if (paint_two == 2) {
        ...
        document.getElementsByClassName('slider-3_two')[0].style.border = "black";
        document.getElementsByClassName('slider-4_two')[0].style.background = "#646464";
        document.getElementsByClassName('slider-4_two')[0].style.border = "#646464";
    }
    if (paint_two == 3) {
        ...
        document.getElementsByClassName('slider-4_two')[0].style.border = "black";
    }
}
